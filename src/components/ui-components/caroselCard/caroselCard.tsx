  ...
  return (
    <>
      <div className="flex w-full items-center">
        ...
        <div className="relative bg-white w-full flex flex-col xl:flex-row justify-start items-center rounded-lg shadow-lg overflow-hidden xl:mx-6 h-full xl:h-[650px] bg-amber-100	">
