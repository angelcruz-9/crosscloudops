...
const Header: React.FC = () => {
  return (
    <AnimatePresence>
      <motion.section
        className="relative pt-40 xl:pt-36 overflow-hidden z-10"
          ...
          <div className="text-center xl:text-left w-full xl:w-1/2">
            ...
            <div className="text-2xl font-bold text-white flex flex-col md:flex-row items-center py-6">
              <img
                ...
                width={120}
              />
              <h3 className="md:ml-8 text-[#fafafa] max-w-lg mx-auto my-2 mt-4 md:mt-0 text-md text-center md:text-left relative z-10">
